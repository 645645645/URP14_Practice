...
namespace UnityEngine.Rendering.Universal
{
    ...
    internal class PostProcessPass : ScriptableRenderPass
    {
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            m_KuwaharaFilter = stack.GetComponent<KuwaharaFilter>();
        ...
        void Render(CommandBuffer cmd, ref RenderingData renderingData)
        {
            ...
            if (useKuwahara)
            {
                ...
                {
                    DoKuwaharaFilter(cmd, GetSource(), GetDestination(), m_Materials.kuwaharaFilter);
                    Swap(ref renderer);
                }
            }
...
#region KuwaharaFilter

        void DoKuwaharaFilter(CommandBuffer cmd, RTHandle source, RTHandle dest, Material kuwaharaMaterial)
        {
            kuwaharaMaterial.SetVector(ShaderConstants._KuwaharaFilterParams, m_KuwaharaFilter.GetParams);
            
            Blitter.BlitCameraTexture(cmd, source, dest,
                                      RenderBufferLoadAction.DontCare, RenderBufferStoreAction.Store, 
                                      kuwaharaMaterial, (int)m_KuwaharaFilter.mode.value);
        }
...
#region Internal utilities
        ...
        class MaterialLibrary
        {
            ...
            public readonly Material kuwaharaFilter;
            ...
            public MaterialLibrary(PostProcessData data)
            {
                ...
                kuwaharaFilter = Load(data.shaders.kuwaharaFilterPS);
            }
            ...
            internal void Cleanup()
            {
                ...
                CoreUtils.Destroy(kuwaharaFilter);
            }
        }
        ...
        static class ShaderConstants
        {
            ...
            public static readonly int _KuwaharaFilterParams = Shader.PropertyToID("_KuwaharaFilterParams");
        }
